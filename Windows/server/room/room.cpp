...
void Room::setFilePath() {
    ...
    string today;
    today = absolutePath + "/chApplogs/" + name + currentDateTime().substr(0,10) + ".txt";
    ...
    if (!dir.cd("chApplogs")) {
        dir.mkpath("chApplogs");
        filepath = absolutePath + "/chApplogs/" + name + currentDateTime().substr(0,10) + ".txt";
    }
    else{
        dir.cd("chApplogs"); // for new rooms;
        filepath = absolutePath + "/chApplogs/" + name + currentDateTime().substr(0,10) + ".txt";
    }
...
void Room::readAllFromFile() {
    ...
    if (logfile.is_open())
    {
        ...
        cout << "Server started(no history found" << endl;
    }
}
