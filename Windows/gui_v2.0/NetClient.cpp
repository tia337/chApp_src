 ...
 *data and call separators. Takes a pointer to the class GUI, the wrapper
 ...
 *Here we deserialize data into a commandname.
 *Due to how our protocol for sending data is specified a valid command must
 *contain at least one breaker sign. If this sign is not present we save the
...
void NetClient::readyRead(){
    ...
    }while (n != -1 ); // do this as long as there is at least one breaker.
}
